...
*/
    ...
    const testnetApi = new ecs.FargateTaskDefinition(this, "TApi", {
      memoryLimitMiB: 1024,
      cpu: 512,
    });
    ...
    entryPoint: ["gunicorn", "-w", "1", "--threads", "3", "-k", "uvicorn.workers.UvicornWorker", "--timeout", "600", "--bind", "0.0.0.0:8000", "apps.http.__init__:app"],
    workingDirectory: "/app/src",
    secrets: {
      PRIVATE_KEY: ecs.Secret.fromSecretsManager(privateKeySecret),
    },
    ...
    const testnetApiCronjobs = new ecs.FargateTaskDefinition(this, "TApiCronjob", {
      memoryLimitMiB: 512,
      cpu: 256,
    });
    ...
    [/*mainnetApi, mainnetApiCronjobs*/, testnetApi, testnetApiCronjobs].forEach((s) => {
...
*/
    ...
    const cronjobFargateServiceTestnet = new ecs.FargateService(
      this,
